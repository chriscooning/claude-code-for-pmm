...
The MCP server automatically categorizes based on keywords. Categories optimized for PM/TPMM work:
...
- **outreach**: Stakeholder communication, partner outreach, user interviews, networking, sales team enablement, customer advocacy programs
- **technical**: Data analysis, technical architecture, system configuration, API work, implementation details, technical analysis
- **research**: User research, market analysis, competitive research, learning new domains, customer discovery
- **writing**: Product specs, PRDs, user stories, technical documentation, solution briefs, white papers, case studies, technical guides
...
**Priority Criteria for PM/TPMM Work:**
