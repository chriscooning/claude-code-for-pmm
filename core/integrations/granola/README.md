...
Sync your [Granola.ai](https://granola.ai) meeting notes and transcripts into your Claude Code for PMM Knowledge folder.
...
```
Set up Granola integration for my Claude Code for PMM
```
...
```json
{
  "mcpServers": {
    "granola": {
      ...
      "env": {
        "KNOWLEDGE_PATH": "/absolute/path/to/your/claude-code-for-pmm/Knowledge"
      }
    }
  }
}
