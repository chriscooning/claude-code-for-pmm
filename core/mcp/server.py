...
def guess_category(item: str) -> str:
    ...
    # Check for TPMM-specific categories first
    if any(word in item_lower for word in ['sales deck', 'battle card', 'sales enablement', 'objection', 'sales training', 'playbook', 'sales collateral']):
        return 'sales-enablement'
    elif any(word in item_lower for word in ['launch', 'gtm', 'go-to-market', 'product launch', 'release', 'launch plan']):
        return 'launch'
    elif any(word in item_lower for word in ['competitive', 'competitor', 'win/loss', 'win loss', 'positioning', 'market intelligence']):
        return 'competitive'
    elif any(word in item_lower for word in ['devrel', 'developer relations', 'developer content', 'api docs', 'technical demo', 'developer advocacy']):
        return 'devrel'
    elif any(word in item_lower for word in ['email', 'contact', 'reach out', 'follow up', 'meeting', 'call']):
        return 'outreach'
...
"""
    elif category == 'sales-enablement':
        base_content += """
## Sales Context
...
## Resources Needed
- [Customer stories, case studies, product docs]
"""
...
- Win strategy: [How to win against them]

## Research Questions
- [What do we need to learn?]
- [What gaps exist in our intel?]
"""
    elif category == 'gtm':
        base_content += """
## GTM Strategy
- Target market: [Who]
- Go-to-market approach: [How]
- Key channels: [Where]
...
"""
    elif category == 'devrel':
        base_content += """
## Developer Audience
- Developer persona: [Who]
...
## Resources
- [Product docs, API references, examples]
"""
