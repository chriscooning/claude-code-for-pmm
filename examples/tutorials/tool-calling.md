...
MCP lets you give Claude custom tools. Claude Code for PMM includes an optional MCP server that adds specialized task management tools.
...
```json
{
  "mcpServers": {
    "manager-ai": {
      ...
      "env": {
        "MANAGER_AI_BASE_DIR": "/path/to/your/claude-code-for-pmm"
      }
    }
  }
}
