...
AI coding agents (Claude Code, Codex, Factory, etc.) don't have persistent memory between sessions by default. Claude Code for PMM solves this with structured files that your agent reads at the start of each conversation.
