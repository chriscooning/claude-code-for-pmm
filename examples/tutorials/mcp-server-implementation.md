...
The Model Context Protocol (MCP) is an open standard that enables AI agents to interact with external systems securely. In Claude Code for PMM, the MCP server acts as the "Product Logic Layer" between the AI and your file system.
...
## Core Features in Claude Code for PMM

Here is how Claude Code for PMM uses MCP to turn a simple markdown system into a smart application.
